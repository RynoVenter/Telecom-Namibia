...
public class PaymentProcess extends VtiUserExit
{
  public VtiUserExitResult execute() throws VtiExitException
  {
    ...
    if (userID == null) return new VtiUserExitResult(999, "Field USERID not found");
...
//      ccType = "";
 ...
 //     ccType = "";
    ...
    if (totalOwing > 0)
    {
	  ...
	  docHeaderLdbRows[0].setFieldValue("USERID", userID.getFieldValue());
    }
    else
    {
    ...
    newPayment.setFieldValue("PURCHORDER", userID.getFieldValue());
