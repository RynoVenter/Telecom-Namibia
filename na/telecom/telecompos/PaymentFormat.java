...
public class PaymentFormat extends VtiUserExit
{
  public VtiUserExitResult execute() throws VtiExitException
  {
	...
	VtiUserExitScreenField isTelRec = getScreenField("IS_TEL_REC");
	VtiUserExitScreenField backPic = getScreenField("B_BACK");
	VtiUserExitScreenField accNumField = getScreenField("ACC_NUM");
    ...
    if (accNumField == null) return new VtiUserExitResult(999, "Field ACC_NUM not found");	
    if (isTelRec == null) return new VtiUserExitResult(999, "Field IS_TEL_REC not found");
	if (backPic == null) return new VtiUserExitResult(999, "Field B_BACK not found");
    ...
    accNumField.setDisplayOnlyFlag(true);
	//Hide back button if it is a tellywalker.
	//if(isTelRec.getFieldValue().equals("X"))
	//	backPic.setHiddenFlag(true);
